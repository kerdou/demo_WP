...
/**
 * Si la classe Cefii_Map n'existe pas...on la crée
 */
    ...
    class Cefii_Map {    
        ...
        function cefii_map_admin_page(){
            ...
            if(isset($_GET['map'])){
                ...
                if($_GET['map'] == 'ok'){
                    echo '<p class="succes">La carte a bien été enregistrée.</p>';
                // cas de map bien supprimée    
                } elseif($_GET['map'] == 'deleteok'){
                    echo '<p class="deleteSucces">La carte a bien été supprimée.</p>';
                }
            }    
        }
        ...
        function cefiiMap_options(){
            ...
            add_settings_field("cleApi", "Votre clé API", array($this, 'champ_cleApi'), "Cefii_Map", "cefiiMap-section");
...
// si la classe Cefii_Map existe déjà on la lance
if(class_exists('Cefii_Map')){
